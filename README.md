...
We calculate patch area (`ha`) and centroid-to-nearest-neighbour distances (`km`) for Old Growth Management Areas (OGMAs), protected areas, and high-value wildlife habitat features.
