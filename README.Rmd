...
We selected the 20th percentile value of all interpatch distances as the maximum search radius (`r targets::tar_read(quantiles_all_dists)[["25%"]] |> prod(0.001) |> round(1)` km).
